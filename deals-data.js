...
window.DEALS_DATA = {
  ...
  "deals": [
    ...
    },
    {
      ...
      "detail": "薅羊毛步骤：\n1. 访问 https://www.jisuapi.com 注册并创建 API Key（OpenAI 兼容）；\n2. 市场首批上线 13 个主流模型，覆盖文本/多模态/代码/推理增强，一个 Key 免去逐个对接鉴权与计费；\n3. 上线福利：所有模型限时 95 折（折上折），充值即返 10% 额外 Credits（充多少送多少）；\n4. 适合想快速试水多模型、又不想分别开户的开发者与小企业。\n注：活动 2026-07-15 起限时、名额有限；以官方活动页为准。",
